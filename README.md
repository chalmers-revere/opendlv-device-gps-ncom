...
```
docker run --init --rm --net=host chalmersrevere/opendlv-device-gps-ncom-multi:v0.0.6 opendlv-device-gps-ncom --ncom_ip=0.0.0.0 --ncom_port=3000 --cid=111 --verbose
```
